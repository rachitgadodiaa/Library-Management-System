...
class BoundFunctionWrapper(_FunctionWrapperBase):
    ...
    def __call__(self, *args, **kwargs):
        ...
        # likely wrapping an instance method vs a static_in_env method or class
        # method.
...
class FunctionWrapper(_FunctionWrapperBase):
    ...
    def __init__(self, wrapped, wrapper, enabled=None):
        ...
        # method, as opposed to a class or static_in_env method. This can
        ...
        # method was a static_in_env method, plus if using Python3, we cannot
        ...
        #
        # This case is a problem because we can no longer tell if the
        # method was a static_in_env method.
        #
        ...
        #
        # As to not being able to identify static_in_env methods properly, we
...
# methods, static_in_env methods and regular functions. Special treatment is
