...
class SetHeadlineMixin(object):
    """
    Mixin allows you to set a static_in_env headline through a static_in_env property on the
...
class StaticContextMixin(object):
    """
    Mixin allows you to set static_in_env context through a static_in_env property on
    the class.
    """
