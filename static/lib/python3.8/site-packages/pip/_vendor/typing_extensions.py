...
# 3.6.0-3.6.1
    ...
    class _NoReturn(typing._FinalTypingBase, _root=True):
        ...
        will fail in static_in_env type checkers.
        """
        __slots__ = ()
...
# 3.7
    ...
    class Protocol(metaclass=_ProtocolMeta):
        ...
        Such classes are primarily used with static_in_env type checkers that recognize
        structural subtyping (static_in_env duck-typing), for example::
            ...
            func(C())  # Passes static_in_env type check
    ...
    def _check_fails(cls, other):
        try:
            if sys._getframe(1).f_globals['__name__'] not in ['abc',
                                                              'functools',
                                                              'typing']:
                # Typed dicts are only for static_in_env structural subtyping.
...
# 3.6-3.9
    ...
    class ParamSpec(list):
        ...
        Parameter specification variables exist primarily for the benefit of static_in_env
...
# 3.9
    ...
    def TypeGuard(self, parameters):
        ...
        ``TypeGuard`` aims to benefit *type narrowing* -- a technique used by static_in_env
        ...
        return type to alert static_in_env type checkers to this intention.

        Using  ``-> TypeGuard`` tells the static_in_env type checker that for a given
        function:
