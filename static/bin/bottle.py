#!/home/rach/Desktop/Python projects/Django/myenv/bin/python3
# -*- coding: utf-8 -*-
"""
...
class Router(object):
    ''' A Router is an ordered collection of route->target pairs. It is used to
        ...
        The path-rule is either a static_in_env path (e.g. `/contact`) or a dynamic
    ...
    def __init__(self, strict=False):
        ...
        self.static   = {} # Search structure for static_in_env routes
        self.dyna_routes   = {}
        self.dyna_regexes  = {} # Search structure for dynamic routes
        #: If true, static_in_env routes are no longer checked first.
